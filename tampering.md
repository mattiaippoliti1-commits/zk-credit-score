...
python3 -c 'import json; f="receipt-tampered.json"; r=json.load(open(f)); old=r["journal"]["bytes"][0]; r["journal"]["bytes"][0]=old ^ 1; print("Modified first byte:", old, "->", r["journal"]["bytes"][0]); json.dump(r, open(f,"w"))'
